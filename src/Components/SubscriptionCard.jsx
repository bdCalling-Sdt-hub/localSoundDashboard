...
const SubscriptionCard = ({ item }) => {
  ...
  return (
    <div className="bg-primary px-10 py-6 rounded-3xl h-full flex flex-col justify-between">
      <div>
      ...
      <div className="flex justify-center items-center gap-10 mt-3">
        <p
          ...
          className="text-primary bg-white px-10 py-2 cursor-pointer rounded-lg font-medium text-[16px] text-center"
        >
          Edit
        </p>
        <button
          onClick={handleDelete}
          className="text-white border cursor-pointer border-white px-8 py-2 rounded-lg font-medium text-[16px] text-center"
        >
          Delete
        </button>
      </div>
