      ...
      },
      {
        ...
        render: (_, record) => (
          <Space size="middle">
              ...
              <BsInfoCircle  onClick={() => navigate('/songs-list/1')}  size={18} className="text-primary cursor-pointer" />
...
>
      ...
      <div className="text-black bg-secondary w-full  border-2 rounded-t-lg">
        <div  className="flex justify-center items-center gap-2 flex-col border-b border-b-gray-300">
          ...
          <p className=" text-[26px] font-bold mb-[16px] my-10">Doctor Details</p>
        </div>
        ...
        <div className="flex justify-between border-b py-[16px]">
          ...
          <div className="flex justify-between border-b py-[16px]">
            <p>Specialized In:</p>
            <p>
              {user?.specializedIn ? user?.specializedIn : "N/A"}
            </p>
          </div>
          <div className="flex justify-between border-b py-[16px]">
            <p>Experience:</p>
          ...
          <div className="flex justify-between border-b py-[16px]">
            <p>Clinic Address:</p>
            <p>
            {user?.clinicAddress ? user?.clinicAddress : "N/A"}
            </p>
          </div>
